...
<lb_script><![CDATA[
	widget_link_base = "<?=build_link('spread','sawce',$id,'playlist','version:1.0')?>";
    widget_swf_base = "<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>";
...
<table cellspacing="0" cellpadding="0" border="0" table class="makebasic">
	<tr>
		<td valign="top" width="50%" style="height: 350px;">
            <div id="embed_frame"><iframe src="<?=build_link('spread','sawce',$id,'playlist','version:1.0')?>" style="width: 250px; height: 350px; border: 3px solid #777;" hspace="0" vspace="0"></iframe></div>
            <div id="embed_swf">
                <object width="250" height="350">
                    <param name="movie" value="<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>"></param> 
                    <param name="SCALE" value="noscale" />
                    <embed src="<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>" type="application/x-shockwave-flash" width="250" height="350" scale="noscale"></embed>
                </object>
            </div>
			<div id="embed_api" class="embed_info">
				...
				<p><a href="<?=build_link('embed','js',$id,'playlist')?>" class="><span>Learn More</span></a></p></div>
				...
				<p><a href="<?=build_link('embed','api',$id,'playlist')?>" class="><span>Learn More</span></a></p></div>
			</div>
        </td>
		<td valign="top" width="50%">
			<label>How it Works</label><p>Embed this playlist wherever you can to make sales through it. Perfect for your website, MySpace, Facebook or other social profile.</p>
	...
	<tr><td colspan="2">
        ...
        <input readonly="" style="width: 580px;" type="text" value='<iframe src="<?=build_link('spread','sawce',$id,'playlist','version:1.0')?>" style="width: 100%; height: 100%; border: none;" hspace="0" vspace="0"></iframe>' class="field" id="embed_code" onclick="javascript:document.embedForm.embed_code.focus();document.embedForm.embed_code.select();" />
        <input readonly="" style="width: 580px;" type="text" value='<object table height="400"><param name="movie" value="<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>"></param><param name="SCALE" value="noscale" /><embed src="<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>" type="application/x-shockwave-flash" table height="400" scale="noscale"></embed></object>' class="field" id="swf_code" onclick="javascript:document.embedForm.swf_code.focus();document.embedForm.swf_code.select();" />
    </td></tr>
</table>
</form>
