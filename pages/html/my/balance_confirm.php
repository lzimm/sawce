...
<form action="<?=build_link_secure('checkout',$reqstring)?>" method="post" class="makeform">
...
<table class="makebasic rowlines" table cellpadding="0" cellspacing="0">
	<tr class="first_row">
		...
		<td width="40%"><label>Purchase Credits</label>$<?=$credits->get(isset($req['min'])?$req['min']:'0.00');?></td>
	</tr>
