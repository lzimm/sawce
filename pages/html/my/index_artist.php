...
<div id="trans_panel" class="page">
    <table cellspacing="0" cellpadding="0"><tr>
        <td width="25%" class="first" valign="top">
            <h4>Your Best Songs</h4>
            <ul>
            
<?php foreach($best_songs as $i => $song) { ?>
...
<?php } ?>
        ...
        <td width="25%" valign="top">
            <h4>Your Best Fans</h4>
            <ul>

<?php foreach($best_fans as $i => $fan) { ?>
                <li><?=$fan['user']->_username?></li>
<?php } ?>            
            
            </ul>
        </td>
        <td width="25%" valign="top">
            <h4>Your Newest Fans</h4>
            <ul>
            
<?php foreach($new_fans as $i => $fan) { ?>
                <li><?=$fan['user']->_username?></li>
<?php } ?>
