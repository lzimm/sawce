...
<label>How it Works</label><p>Embed this playlist wherever you can and make sales through it. Perfect for your website, MySpace, Facebook or other social profile.</p>
...
<input readonly="" type="text" value='<iframe src="<?=build_link('spread','sawce',$id,'playlist','version:1.0')?>" style="width: 100%; height: 100%; border: none;" hspace="0" vspace="0"></iframe>' class="field" id="embed_code" onclick="javascript:document.embedForm.embed_code.focus();document.embedForm.embed_code.select();" />
<input readonly="" type="text" value='<object table height="400"><param name="movie" value="<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>"></param><param name="SCALE" value="noscale" /><embed src="<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>" type="application/x-shockwave-flash" table height="400" scale="noscale"></embed></object>' class="field" id="swf_code" onclick="javascript:document.embedForm.swf_code.focus();document.embedForm.swf_code.select();" /></div>
	
</td><td valign="top" width="440">
	
<div style="height: 350px;">	
	<div id="embed_frame"><iframe src="<?=build_link('spread','sawce',$id,'playlist','version:1.0')?>" style="width: 440px; height: 350px; border: none;" hspace="0" vspace="0"></iframe></div>
    <div id="embed_swf">
        <object width="440" height="350">
            ...
            <embed src="<?=build_link('spread','player')?>/playlist.swf?user=<?=$owner->_username?>&playlist=<?=$id?>" type="application/x-shockwave-flash" width="440" height="350" scale="noscale"></embed>
        </object>
    </div>
	<div id="embed_api" class="embed_info">
		...
		<p><a href="<?=build_link('embed','js',$id,'playlist')?>" class="learn_btn"><span>Learn More</span></a></p></div>
		...
		<p><a href="<?=build_link('embed','api',$id,'playlist')?>" class="learn_btn"><span>Learn More</span></a></p></div>
	</div>
</div>
