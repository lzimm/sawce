...
<h3>Lost Password</h3>
<p>Enter your email address and your password will be mailed to you.</p>
<form action="<?=build_link('users','password')?>" method="post" class="makeform">
<table class="makebasic" cellpadding="0" cellspacing="0">
    <tr>
        <td width="50%"><label>Email</label><?=$u_email->build();?></td>
        <td width="50%"><label>Get Password</label><?=$u_submit->build();?></td>
    </tr>
</table>
</form>
</div></div>
